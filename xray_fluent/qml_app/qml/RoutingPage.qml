...
Item {
    ...
    Dialog {
        ...
        contentItem: ColumnLayout {
            ...
            Text {
                Layout.fillWidth: true
                text: I18n.t("Быстрые пресеты зависят от регионального профиля в настройках сети. Пресет «Всё кроме региона» пускает ресурсы выбранной страны напрямую, а остальной трафик — через прокси.\n\nСервисы:\n«Прокси» — всегда вести сервис через VPN/прокси.\n«Прямой» — всегда вести сервис напрямую.\n\nПравила по приложениям работают только в режиме TUN.")
