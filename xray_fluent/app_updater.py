    ...
    def run(self) -> None:
        ...
        try:
            ...
            script_text = "\r\n".join([
                ...
                "foreach ($coreName in @('xray','sing-box','singbox','winws','tun2socks','warp-svc')) { Get-Process -Name $coreName -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue }",
