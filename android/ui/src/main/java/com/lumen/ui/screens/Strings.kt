...
class LumenStrings {
    ...
    var socks5Copy = "Copy"
    var socks5ReconnectNote = "Changes take effect after reconnecting the VPN or local proxy."
    var socks5CredentialError = "Login and password must each contain 1–255 UTF-8 bytes, without control characters. Spaces are preserved."
    ...
    var updateAvailableVersion = "Update available {version}"
...
private val RU = LumenStrings().apply {
    ...
    updateAvailableVersion="Доступно обновление {version}"
    ...
    socks5Copy="Копировать"
    socks5ReconnectNote="Изменения применяются после переподключения VPN или локального прокси."
    socks5CredentialError="Логин и пароль: каждый от 1 до 255 байт UTF-8, без управляющих символов. Пробелы сохраняются."
...
private val ZH = LumenStrings().copyFrom(EN).apply {
    ...
    updateAvailable="有新的 Android 版本可用"; updateAvailableVersion="有可用更新 {version}"; upToDate="当前已是最新 Android 版本"
...
private val FA = LumenStrings().apply {
    ...
    updateAvailable="نسخه جدید Android موجود است"; updateAvailableVersion="به‌روزرسانی {version} موجود است"; upToDate="آخرین نسخه Android نصب است"
