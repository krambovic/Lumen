...
Bebra KVN является форком (Zapret-KVN)(https://github.com/youtubediscord/zapret-kvn).
...
> 
> Сообщить о проблеме рекомендуем ТОЛЬКО сюда: [Issues](https://github.com/krambovic/bebra-kvn/issues)


## Что это

Bebra KVN объединяет несколько проверенных инструментов (xray-core, sing-box, Zapret) в одну программу с удобным интерфейсом. Под капотом — оркестрация ядер для максимальной скорости и совместимости с любым транспортом.
...
1. Скачайте установщик со страницы [Releases](https://github.com/krambovic/bebra-kvn/releases)
2. Запустите скачанный `.exe` — он распакует программу в выбранную папку
3. Запустите `BebraVPN.exe` из этой папки
...
- [Сообщить о проблеме](https://github.com/krambovic/bebra-kvn/issues)
